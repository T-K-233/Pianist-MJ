...
PRIME_WUJI_XML: Path = (
    Path("data") / "assets" / "robots" / "prime" / "mjcf" / "prime_wuji.xml"
)
assert PRIME_WUJI_XML.exists()


def get_assets(meshdir: str) -> dict[str, bytes]:
    assets: dict[str, bytes] = {}
    update_assets(assets, PRIME_WUJI_XML.parent.parent / "meshes", meshdir)
    return assets


def get_spec() -> mujoco.MjSpec:
    spec = mujoco.MjSpec.from_file(str(PRIME_WUJI_XML))
...
PRIME_WUJI_PALM_BODY_NAMES = [
    "left_palm_link",
    "right_palm_link",
]

PRIME_WUJI_FINGER_BODY_NAMES = [
    "left_finger1_link4",
    "left_finger2_link4",
    "left_finger3_link4",
    "left_finger4_link4",
...
FINGER1_J1_CFG = BuiltinPositionActuatorCfg(
    joint_names_expr=(
        "left_finger1_joint1",
...
FINGER1_J2_CFG = BuiltinPositionActuatorCfg(
    joint_names_expr=(
        "left_finger1_joint2",
...
FINGER2_5_J1_CFG = BuiltinPositionActuatorCfg(
    joint_names_expr=(
        "left_finger2_joint1",
        "left_finger3_joint1",
        "left_finger4_joint1",
...
FINGER2_5_J2_CFG = BuiltinPositionActuatorCfg(
    joint_names_expr=(
        "left_finger2_joint2",
        "left_finger3_joint2",
        "left_finger4_joint2",
...
FINGERS_J3_CFG = BuiltinPositionActuatorCfg(
    joint_names_expr=(
        "left_finger1_joint3",
        "left_finger2_joint3",
        "left_finger3_joint3",
...
FINGERS_J4_CFG = BuiltinPositionActuatorCfg(
    joint_names_expr=(
        "left_finger1_joint4",
        "left_finger2_joint4",
        "left_finger3_joint4",
...
def get_prime_wuji_robot_cfg() -> EntityCfg:
...
if __name__ == "__main__":
    ...
    robot = Entity(get_prime_wuji_robot_cfg())
